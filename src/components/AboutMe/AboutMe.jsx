    ...
    <StyledAbout>
        <div className="wrapper">
            ...
            <div className="descr">
                ...
                <Divider />
                <p className="text"><strong>Date of Birth:</strong> January 28, 2004</p>
                <p className="text"><strong>Location:</strong> Yerevan, Armenia</p>
                <p className="text"><strong>Languages:</strong></p>
                <ul>
                    <li className="text">Armenian (Conversational)</li>
